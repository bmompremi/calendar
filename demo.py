#!/usr/bin/env python3
"""
Demo script for Haiti Banking Management System
Demonstrates all features of the banking system
"""
...
def demo():
    """Run the demo"""
    print_section("HAITI BANKING MANAGEMENT SYSTEM - DEMO")
    ...
    print("The Haiti Banking Management System is ready to use.")
